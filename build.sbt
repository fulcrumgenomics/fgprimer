...
////////////////////////////////////////////////////////////////////////////////////////////////
assemblyJarName in assembly := "fgprimer-" + version.value + ".jar"
...
lazy val commonSettings = Seq(
  ...
  homepage             := Some(url("https://github.com/fulcrumgenomics/fgprimer")),
  startYear            := Some(2021),
  scalaVersion         := "2.13.6",
...
lazy val root = Project(id="fgprimer", base=file("."))
  .settings(commonSettings: _*)
  .settings(assemblySettings: _*)
  .settings(description := "fgprimer")
  .settings(
